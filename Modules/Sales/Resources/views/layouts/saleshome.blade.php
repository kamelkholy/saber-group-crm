...
@section('sabercrm')
<title>Saber Group - Sales Home</title>
...
<div class="page-content-wrapper">
    ...
    <div class="container-fluid">
        ...
        <img style="display: block;margin: auto;padding-top: 20px;padding-bottom: 10px" width="200px" src="{{url('/public/pic/logo.png')}}" height="90px" alt="logo">
