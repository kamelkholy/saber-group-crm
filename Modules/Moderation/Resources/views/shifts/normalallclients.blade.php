...
@section('sabercrm')
<title>Saber Group - Normal Shift Report</title>
                                ...
                                <div class="col-12">
                                    <div class="card m-b-30">
                                        <div  class="card-body">
                                            ...
                                            <h4 class="mt-0 header-title">Normal Shift Report</h4>
                                        ...
                                        <form method="POST" action="{{url('/moderation/normalallclientsreport')}}">
                                        {{csrf_field()}}
                                            <div class="row">
