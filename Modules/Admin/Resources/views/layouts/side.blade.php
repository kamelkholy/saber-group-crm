    ...
    <div class="sidebar-inner slimscrollleft">
        <div id="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="{{url('/admin')}}" class="waves-effect"><i class="dripicons-device-desktop"></i><span> Dashboard
                        </span></a>
                </li>
...
>
                ...
                <li class="has_sub">
                    <a href="javascript:void(0);" class="waves-effect"><i class="fa fa-pie-chart "></i> <span> Clients
                            <span class="float-right"><i class="mdi mdi-chevron-right"></i></span></span> </a>
                    <ul class="list-unstyled">
                        <li><a href="{{url('/admin/addnewclient')}}">Add Client</a></li>
                        <li><a href="{{url('/admin/clientlist')}}">Manage Clients</a></li>
                ...
                <li class="has_sub">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="{{url('/admin/addnewuser')}}">Add User</a></li>
                        <li><a href="{{url('/admin/userlist')}}">Manage User</a></li>
