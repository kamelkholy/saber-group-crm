...
@section('articka')
<title>Articka - Basic Data</title>
@include('basicdata::layouts.side')
                        ...
                        <div class="container-fluid">
                            <div class="row">
                                <div class="col-md-6 col-xl-4">
                                    <div class="card text-center m-b-30">
                                        <div class="mb-2 card-body text-muted">
                                            <a style="font-size: 25px;font-weight: bold;" class="text-info" href="{{url('/product/producthome')}}">
                                                Go To Product
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="card text-center m-b-30">
                                        <div class="mb-2 card-body text-muted">
                                            <a style="font-size: 25px;font-weight: bold;" class="text-purple" href="{{url('/courses/homecourse_admin')}}">
                                                Go To Courses
                                            </a>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6 col-xl-4">
                                    <div class="card text-center m-b-30">
                                        <div class="mb-2 card-body text-muted">
                                            <a style="font-size: 25px;font-weight: bold;" class="text-primary" href="{{url('/blog/homeblog')}}">
                                                Go To Blog
                                            </a>
                                        </div>
                                    </div>
...
@include('basicdata::layouts.footer')
@endsection
